...
import { addTimeline } from "@/redux/slices/timelineSlice";
...
const AddTimeline = () => {
  ...
  const handleAddNewTimeline = (e) => {
    ...
    dispatch(addTimeline(formData)).then((result) => {
      if (addTimeline.fulfilled.match(result)) {
        ...
        setTo("");
        navigate("/");
      } else if (addTimeline.rejected.match(result)) {
        const errorMessage =
