  ...
  const handleAddNewProject = (e) => {
    ...
    dispatch(addProject(formData)).then((result) => {
      if (addProject.fulfilled.match(result)) {
        ...
        setDeployed("");
        navigate('/')
      } else if (addProject.rejected.match(result)) {
        const errorMessage =
      ...
      <div className="flex mt-7 justify-center items-center min-h-[100vh] sm:gap-4 sm:py-4 sm:pl-14">
        ...
        >
          ...
          <div className="mt-6 flex items-center justify-end gap-x-6">
            <Button
              type="submit"
              className="rounded-md bg-black px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-gray-800 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black w-56"
            >
              Add Project
            </Button>
          </div>
