...
import { deleteMessages, getMessages } from "@/redux/slices/messageSlice";
...
const Messages = () => {
  ...
  const handleMessageDelete = (id) => {
    setMessageId(id);
    dispatch(deleteMessages(id)).then((result) => {
      if (deleteMessages.fulfilled.match(result)) {
        toast.success("Message deleted successfully");
        dispatch(getMessages());
      } else if (deleteMessages.rejected.match(result)) {
        const errorMessage =
