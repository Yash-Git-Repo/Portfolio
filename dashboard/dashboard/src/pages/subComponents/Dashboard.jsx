...
const Dashboard = () => {
  ...
  const softwareApplications = useSelector(
  ...
  const handleDeleteSoftwareApp = (id) => {
    setAppId(id);
    const result = dispatch(deleteApplication(id)).then((result) => {
      if (deleteApplication.fulfilled.match(result)) {
        toast.success("Application deleted successfylly");
        dispatch(getApplication());
      } else if(deleteApplication.rejected.match(result)) {
        const errorMessage =
